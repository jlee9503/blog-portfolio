...
tags: [SQL Server, T-SQL, ETL Pipeline, Medallion Architecture]
---
...
![data-architecture](https://raw.githubusercontent.com/jlee9503/data-warehouse/main/images/medallion-architecture.png)
...
## 5. Code Reference
- [See full analysis](https://github.com/jlee9503/data-warehouse)
- Clone this repository:
   ```bash
   git clone https://github.com/jlee9503/data-warehouse.git
   cd sql-scripts
   ```